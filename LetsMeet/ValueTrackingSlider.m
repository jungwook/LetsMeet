...
#import "ValueTrackingSlider.h"
#import "ValuePopupView.h"

@interface ValueTrackingSlider() <ValuePopupViewDelegate>
@property (strong, nonatomic) ValuePopupView *popUpView;
@property (nonatomic) BOOL popUpViewAlwaysOn; // default is NO
@end

@implementation ValueTrackingSlider
{
...
- (void)setup
{
    ...
    self.popUpView = [[ValuePopupView alloc] initWithFrame:CGRectZero];
