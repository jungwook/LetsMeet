 ...
 */
typedef NS_ENUM (NSUInteger, SayLayoutItemRenderDirection) {
  SayLayoutItemRenderDirectionShortestFirst,
  SayLayoutItemRenderDirectionLeftToRight,
  SayLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const SayElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const SayElementKindSectionFooter;

#pragma mark - SayDelegateLayout

@class SayLayout;

/**
 *  The SayDelegateLayout protocol defines methods that let you coordinate with a
 *  SayLayout object to implement a waterfall-based layout.
 ...
 */
@protocol SayDelegateLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - SayLayout

/**
 *  The SayLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `SayDelegateLayout` protocol.
 *
 ...
 *
 *  @note SayLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface SayLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (SayLayoutItemRenderDirectionLeftToRight), right to left (SayLayoutItemRenderDirectionRightToLeft), or shortest column fills first (SayLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: SayLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) SayLayoutItemRenderDirection itemRenderDirection;
